...
/**
 * Create Express middleware for handling payment portal routes
 */
export function createExpressMiddleware(
  ...
  router.get('/:id', async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
      const { id } = req.params;
      const result = await server.handlePaymentLinkRequest(id);
 ...
 */
export function createUniversalHandler(server: PortalServer) {
