...
[![npm version](https://img.shields.io/npm/v/@payportal/portal.svg)](https://www.npmjs.com/package/@payportal/portal)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![Node.js](https://img.shields.io/badge/Node.js-18%2B-green.svg)](https://nodejs.org/)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.0-blue.svg)](https://www.typescriptlang.org/)
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](CONTRIBUTING.md)

> **Stripe for Web3** — Self-hosted payment gateway with blockchain verification

Self-hosted payment portal with 402/403 protocol and blockchain payment verification.
...
npx portal --mock --mock-solana --api-key your-secret-key
...
```json
{
  ...
  "paymentUri": "solana:YourAddress?amount=0.5&label=Pay%20Portal%20Payment",
...
X-PayPortal-Event: payment.confirmed
X-PayPortal-Event-Id: evt_abc123_xyz789
X-PayPortal-Timestamp: 2024-01-15T10:30:00.000Z
X-PayPortal-Signature: <HMAC-SHA256 signature>
```

### Verifying Webhook Signatures

```javascript
const { verifyWebhookSignature } = require('@payportal/portal');

app.post('/webhook', express.raw({ type: 'application/json' }), (req, res) => {
  const signature = req.headers['x-payportal-signature'];
...
### Solana (Solana Pay)
```
solana:<recipient>?amount=<amount>&label=Pay%20Portal%20Payment&message=Payment%20for%20<id>
```
