...
/**
 * Pay Portal CLI v1.0.0
 * Quick way to start a payment portal server
 * 
 * Usage:
 *   npx portal --port 3000 --chain 1:https://eth-rpc.example.com
 *   npx portal --solana https://api.mainnet-beta.solana.com
 *   npx portal --webhook https://your-server.com/webhook
 */
...
Examples:
  ...
  portal --mock --mock-solana --api-key secret123

  # Start with Ethereum mainnet
  portal -c 1:Ethereum:ETH:https://eth-mainnet.g.alchemy.com/v2/YOUR_KEY

  # Start with Solana mainnet
  portal --solana https://api.mainnet-beta.solana.com --api-key secret

  # Multiple chains with webhook
  portal -c 1:https://eth-rpc.com --solana -w https://your-server.com/webhook
